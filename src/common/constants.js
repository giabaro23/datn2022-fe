...
export const TOPIC_ALL = [{
  ...
  },
  {
    ...
    subTopic: [
      "Thiết kế nội thất nhà và chung cư",
      "Thiết kế ngoại thất",
      "Thiết kế xây dựng nhà",
      "Dựng phối cảnh 3D",
      "Việc kiến trúc và xây dựng khác"
    ]
  },
  {
    ...
    subTopic: [
      ...
      "Tổ chức sự kiện",
      "Quảng cáo facebook",
      "Việc kinh doanh và marketing khác",
    ]
  },
  {
    topicName: "Thiết kế",
  ...
  },
  {
    ...
    subTopic: [
      "Video hoạt hình",
      "Video review",
      "Video giới thiệu sản phẩm và công ty",
      "Việc làm về video khác"
    ]
  },
  {
...
export const PAY_TYPE =["Trả theo dự án","Trả theo tháng", "Trả theo giờ"]
export const WORK_TYPE=["Toàn thời gian", "Bán thời gian"]